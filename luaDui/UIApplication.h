...
#define WM_ACTIVATE_THREAD (WM_USER+0x122)
	...
	public:
		...
		static CDuiString GetInstancePath() { return CPaintManagerUI::GetInstancePath(); }
		static CDuiString GetCurrentPath() { return CPaintManagerUI::GetCurrentPath(); }
		static HINSTANCE GetResourceDll() { return CPaintManagerUI::GetResourceDll(); }
		static const CDuiString& GetResourcePath() { return CPaintManagerUI::GetResourcePath(); }
		static const CDuiString& GetResourceZip() { return CPaintManagerUI::GetResourceZip(); }
