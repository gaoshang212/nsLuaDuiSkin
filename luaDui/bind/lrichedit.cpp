...
namespace lbindrichedit
{
	...
	bool textFormatFromLua(LuaTable ltab, CHARFORMAT2 & format)
	{
		...
		{
			mask |= CFM_FACE;
			_tcscpy(format.szFaceName, CDuiString(lvalue.toLPCTSTR()));//小于32个字符
		}
	...
	LBIND_END_DEFINE_FUNC
		...
		LBIND_DEFINE_FUNC(CRichEditUI, IsWordWrap)
		return L.lreturn(pThis->IsWordWrap());
	LBIND_END_DEFINE_FUNC
	...
	LBIND_END_DEFINE_FUNC
		...
		return L.lreturn(pThis->GetText().GetData());
	LBIND_END_DEFINE_FUNC

		LBIND_DEFINE_FUNC(CRichEditUI, SetText)
		pThis->SetText(CDuiString(arg[2].toLPCTSTR()));
	LBIND_END_DEFINE_FUNC
	...
	LBIND_END_DEFINE_FUNC
		...
		LBIND_DEFINE_FUNC(CRichEditUI, IsModify)
		return L.lreturn(pThis->IsModify());
	LBIND_END_DEFINE_FUNC
	...
	LBIND_END_DEFINE_FUNC
		...
		pThis->ReplaceSel(CDuiString(arg[2].toLPCTSTR()), arg[3].toBool());
	LBIND_END_DEFINE_FUNC

		LBIND_DEFINE_FUNC(CRichEditUI, GetSelText)
		return L.lreturn(pThis->GetSelText().GetData());
	LBIND_END_DEFINE_FUNC
	...
	LBIND_END_DEFINE_FUNC
		...
		pThis->InsertText(arg[2].toInt(), CDuiString(arg[3].toLPCTSTR()), arg[4].toBool());
	LBIND_END_DEFINE_FUNC

		LBIND_DEFINE_FUNC(CRichEditUI, AppendText)
		pThis->AppendText(CDuiString(arg[2].toLPCTSTR()), arg[3].toBool());
	LBIND_END_DEFINE_FUNC
...
LBIND_BEGIN_DEFINE_LIB(CRichEditUI)
{
	...
	{ "isWordWrap",lbindrichedit::IsWordWrap },
