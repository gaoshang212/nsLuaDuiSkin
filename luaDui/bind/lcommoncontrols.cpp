...
LBIND_DEFINE_FUNC(COptionUI,SetSelectedImage)
	pThis->SetSelectedImage(CDuiString(arg[2].toLPCTSTR()));
LBIND_END_DEFINE_FUNC
...
LBIND_DEFINE_FUNC(COptionUI,SetForeImage)
	pThis->SetForeImage(CDuiString(arg[2].toLPCTSTR()));
LBIND_END_DEFINE_FUNC
...
LBIND_DEFINE_FUNC(COptionUI,SetGroup)
	pThis->SetGroup(CDuiString(arg[2].toLPCTSTR()));
LBIND_END_DEFINE_FUNC
...
LBIND_DEFINE_FUNC(CSliderUI,SetThumbImage)
	pThis->SetThumbImage(CDuiString(arg[2].toLPCTSTR()));
LBIND_END_DEFINE_FUNC
...
LBIND_DEFINE_FUNC(CSliderUI,SetThumbHotImage)
	pThis->SetThumbHotImage(CDuiString(arg[2].toLPCTSTR()));
LBIND_END_DEFINE_FUNC
...
LBIND_DEFINE_FUNC(CSliderUI,SetThumbPushedImage)
	pThis->SetThumbPushedImage(CDuiString(arg[2].toLPCTSTR()));
LBIND_END_DEFINE_FUNC
}
