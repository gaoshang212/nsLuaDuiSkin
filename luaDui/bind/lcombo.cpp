...
namespace lbindcombo
{
	...
	LBIND_END_DEFINE_FUNC
		...
		pThis->SetDropBoxAttributeList(CDuiString(arg[2].toLPCTSTR()));
	LBIND_END_DEFINE_FUNC
	...
	LBIND_END_DEFINE_FUNC
		...
		pThis->SetNormalImage(CDuiString(arg[2].toLPCTSTR()));
	LBIND_END_DEFINE_FUNC
	...
	LBIND_END_DEFINE_FUNC
		...
		pThis->SetHotImage(CDuiString(arg[2].toLPCTSTR()));
	LBIND_END_DEFINE_FUNC
	...
	LBIND_END_DEFINE_FUNC
		...
		pThis->SetPushedImage(CDuiString(arg[2].toLPCTSTR()));
	LBIND_END_DEFINE_FUNC
	...
	LBIND_END_DEFINE_FUNC
		...
		pThis->SetFocusedImage(CDuiString(arg[2].toLPCTSTR()));
	LBIND_END_DEFINE_FUNC
	...
	LBIND_END_DEFINE_FUNC
		...
		pThis->SetDisabledImage(CDuiString(arg[2].toLPCTSTR()));
	LBIND_END_DEFINE_FUNC
	...
	LBIND_END_DEFINE_FUNC
		...
		pThis->SetItemBkImage(CDuiString(arg[2].toLPCTSTR()));
	LBIND_END_DEFINE_FUNC
	...
	LBIND_END_DEFINE_FUNC
		...
		pThis->SetSelectedItemImage(CDuiString(arg[2].toLPCTSTR()));
	LBIND_END_DEFINE_FUNC
	...
	LBIND_END_DEFINE_FUNC
		...
		pThis->SetHotItemImage(CDuiString(arg[2].toLPCTSTR()));
	LBIND_END_DEFINE_FUNC
	...
	LBIND_END_DEFINE_FUNC
		...
		pThis->SetDisabledItemImage(CDuiString(arg[2].toLPCTSTR()));
	LBIND_END_DEFINE_FUNC

		LBIND_DEFINE_FUNC(CComboUI, SetItemHLineColor)
		pThis->SetItemHLineColor(arg[2].toInt());
	LBIND_END_DEFINE_FUNC

		LBIND_DEFINE_FUNC(CComboUI, GetItemHLineColor)
		return L.lreturn(pThis->GetItemHLineColor());
	LBIND_END_DEFINE_FUNC

		LBIND_DEFINE_FUNC(CComboUI, SetItemVLineColor)
		pThis->SetItemVLineColor(arg[2].toInt());
	LBIND_END_DEFINE_FUNC

		LBIND_DEFINE_FUNC(CComboUI, GetItemVLineColor)
		return L.lreturn(pThis->GetItemVLineColor());
	LBIND_END_DEFINE_FUNC
...
LBIND_BEGIN_DEFINE_LIB(CComboUI)
{
	...
	{ "setItemHLineColor",lbindcombo::SetItemHLineColor },
	{ "itemHLineColor",lbindcombo::GetItemHLineColor },
	{ "setItemVLineColor",lbindcombo::SetItemVLineColor },
	{ "itemVLineColor",lbindcombo::GetItemVLineColor },
