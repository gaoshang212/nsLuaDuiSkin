...
namespace lbind
{
	...
	LBIND_DEFINE_FUNC(CControlUI, GetWindow)
		auto map = CWindowUI::GetWindows();
	HWND hwnd = pThis->GetManager()->GetPaintWindow();
	CWindowUI* window = map[hwnd];
	if (window)
	{
		return L.lreturn(window->_lbindCToLua(&L));
	}
	...
	LBIND_END_DEFINE_FUNC
		...
		pThis->SetToolTip(CDuiString(arg[2].toLPCTSTR()));
	LBIND_END_DEFINE_FUNC
	...
	LBIND_END_DEFINE_FUNC
		...
		pThis->SetUserData(CDuiString(arg[2].toLPCTSTR()));
	LBIND_END_DEFINE_FUNC
	...
	LBIND_END_DEFINE_FUNC
		...
		pThis->SetName(CDuiString(arg[2].toLPCTSTR()));
	LBIND_END_DEFINE_FUNC
	...
	LBIND_END_DEFINE_FUNC
		...
		pThis->SetBkImage(CDuiString(arg[2].toLPCTSTR()));
	LBIND_END_DEFINE_FUNC
	...
	LBIND_DEFINE_FUNC(CControlUI, GetBorderSize)
		return L.lreturn(toLua(L,pThis->GetBorderSize()));
	LBIND_END_DEFINE_FUNC
